    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(default='SuperUser', max_length=15, unique=True)),
                ...
                ('domain1', models.CharField(blank=True, max_length=20, null=True)),
                ('domain2', models.CharField(blank=True, max_length=20, null=True)),
